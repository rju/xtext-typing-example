 ...
 * <ul>
 *   <li>{@link de.cau.cs.se.lad.types.impl.PropertyImpl#getType <em>Type</em>}</li>
 *   <li>{@link de.cau.cs.se.lad.types.impl.PropertyImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PropertyImpl extends EObjectImpl implements Property {
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TypesPackage.PROPERTY__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(Type newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.PROPERTY__TYPE, oldType, type));
	}
